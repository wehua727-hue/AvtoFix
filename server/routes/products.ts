...
export const handleProductsCreate: RequestHandler = async (req, res) => {
  try {
    ...
    // ✅ YANGI LOGIKA: SKU bo'yicha qidirish o'tkazib, har doim yangi mahsulot qo'shish
...
export const handleProductHistoryCreate: RequestHandler = async (req, res) => {
  try {
    ...
    const db = conn.db;
    const { userId, type, productId, productName, sku, stock, addedStock, price, currency, message, variants, source } = req.body;
