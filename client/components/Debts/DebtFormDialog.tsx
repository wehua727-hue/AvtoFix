          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="px-6 pb-6 pt-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 pt-4">
              <Button
                ...
                className="w-full bg-slate-800/70 border-slate-700 text-white hover:bg-slate-700 h-11 text-base"
              >
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 hover:from-red-700 hover:via-rose-700 hover:to-pink-700 text-white h-11 font-semibold shadow-lg text-base"
              >
