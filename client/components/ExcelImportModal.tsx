...
import { X, Upload, FileSpreadsheet, Check, AlertCircle, Loader2, Settings2 } from 'lucide-react';
                      ...
                      <table className="w-full text-xs border-collapse">
                        <thead className="sticky top-0 bg-muted/95 backdrop-blur-sm">
                          <tr>
                            ...
                            <th className="px-2 py-1.5 text-center border-r border-border font-semibold text-foreground bg-muted/95 w-[60px]">
                              O'chirish
                            </th>
                            {previewData.headers?.map((header, idx) => (
                            ...
                            <tr key={rowIdx} className="hover:bg-muted/20 border-b border-border/50">
                              ...
                              <td className="px-2 py-1.5 text-center border-r border-border">
                                <button
                                  ...
                                  className="w-8 h-8 flex items-center justify-center text-red-500 hover:text-red-400 hover:bg-red-500/10 rounded transition-colors"
                              ...
                              {row.map((cell: any, cellIdx: number) => (
                                <td key={cellIdx} className="px-2 py-1.5 border-r border-border text-foreground">
