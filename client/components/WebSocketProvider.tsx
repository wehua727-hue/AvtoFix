    ...
    onMessage: (message) => {
      ...
      switch (message.type) {
        case 'product-updated':
          // Agar variant ota mahsulotga aylantirilgan bo'lsa
          if (message.action === 'variant-promoted') {
            notification.info('Mahsulot yangilandi', `"${message.oldProductName}" o'chirildi, "${message.productName}" ota bo'ldi`);
          } else {
          ...
          window.dispatchEvent(new CustomEvent('product-updated', { 
            detail: { 
              ...
              oldProductName: message.oldProductName,
