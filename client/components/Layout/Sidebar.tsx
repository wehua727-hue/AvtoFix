...
import { Layers, Users, Wallet, UserCheck, MenuIcon, X, Calculator, UserCog, Crown, Shield, ArrowLeft } from 'lucide-react';
...
export default function Sidebar({
  ...
  const { user, originalUser, returnToOriginal } = useAuth();
    ...
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-screen
          ...
          transition-all duration-300 z-[9999] flex flex-col
          ...
          <div className="lg:hidden">
            ...
            {originalUser && (
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-blue-400 bg-blue-500/10 hover:bg-blue-500/20 transition-colors"
              >
