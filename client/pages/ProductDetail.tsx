...
interface Product {
  ...
  name: string;
  code: string;
  catalogNumber?: string; // Katalog raqami (№ по каталогу)
  stock: number;
  price: number;
  basePrice?: number;
      ...
      try {
        ...
        if (data?.success && data.product && !isCancelled) {
          ...
          setProduct({
            ...
            name: p.name,
            code: p.sku ?? "",
            catalogNumber: (p as any).catalogNumber ?? "", // Katalog raqami
            ...
            <div className="flex flex-col md:flex-row gap-6 items-stretch">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-3">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        const displayId = selectedVariant ? `${product.id}-variant` : product.id;
                ...
                <div className="grid grid-cols-2 gap-3">
                  {/* Mahsulot kodi (Exceldan kelgan kod) */}
                  {(selectedVariant ? selectedVariant.catalogNumber : product.catalogNumber) && (
                    <div className="bg-card border border-border rounded-lg p-3 hover:border-border transition-all group">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">
                          {selectedVariant ? 'Xil kodi' : 'Mahsulot kodi'}
                        </span>
                      </div>
