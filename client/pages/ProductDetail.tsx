                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      {variant.price ? (
                        <span className="text-sm font-semibold text-red-400 group-hover:text-red-300 transition-colors whitespace-nowrap">
                          {formatMoney(variant.price)} so'm
                        </span>
                      ) : (
                        <span className="text-xs text-gray-500 italic">Narx yo'q</span>
                      )}
                      {/* Currency description for variant */}
                      {(() => {
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {(selectedVariant ? selectedVariant.basePrice !== undefined : product.basePrice !== undefined) && (
                    <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-red-600/30 rounded-xl p-3 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-900/20 transition-all group">
                      ...
                      <span className="text-base font-bold text-white">
                        {formatMoney(selectedVariant ? (selectedVariant.basePrice ?? 0) : (product.basePrice ?? 0))} so'm
                      </span>
                    </div>
                  )}
                  ...
                  <div className="bg-gradient-to-br from-red-600 via-red-700 to-red-600 border border-red-500/50 rounded-xl p-3 shadow-xl shadow-red-900/50 hover:shadow-2xl hover:shadow-red-900/60 transition-all group">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[10px] font-semibold text-red-100">so'm</span>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-blue-300">Jami narx</p>
                    ...
                    <div className="text-center py-4">
                      <p className="text-3xl font-black text-white mb-2 tracking-tight">
                        {formatMoney(
                          (selectedVariant ? (selectedVariant.basePrice ?? selectedVariant.price ?? 0) : (product.basePrice ?? product.price ?? 0)) * 
                          (selectedVariant ? (selectedVariant.stock ?? 0) : (product.stock ?? 0))
                        )}
                      </p>
                      <p className="text-sm font-semibold text-blue-300 mb-3">so'm</p>
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg px-3 py-2">
                        <p className="text-xs font-mono text-blue-300/80">
                          {formatMoney(selectedVariant ? (selectedVariant.basePrice ?? selectedVariant.price ?? 0) : (product.basePrice ?? product.price ?? 0))} × {selectedVariant ? (selectedVariant.stock ?? 0) : (product.stock ?? 0)}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-green-300">Sof foyda</p>
                          <p className="text-xs text-green-400/80">Sotiladigan narx × Soni - Jami narx</p>
                        </div>
                      </div>
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-sm font-semibold text-green-300 mb-3">so'm</p>
                      ...
                      <div className="bg-green-500/10 border border-green-500/20 rounded-lg px-3 py-2">
                        <p className="text-xs font-mono text-green-300/80 break-all">
                          ({formatMoney(selectedVariant ? (selectedVariant.price ?? 0) : (product.price ?? 0))} × {selectedVariant ? (selectedVariant.stock ?? 0) : (product.stock ?? 0)}) - ({formatMoney(selectedVariant ? (selectedVariant.basePrice ?? selectedVariant.price ?? 0) : (product.basePrice ?? product.price ?? 0))} × {selectedVariant ? (selectedVariant.stock ?? 0) : (product.stock ?? 0)})
                        </p>
                      </div>
                    </div>
                  </div>
