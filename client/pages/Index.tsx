    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className={`pt-16 sm:pt-18 lg:pt-20 transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-20' : 'lg:pl-80'}`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="rounded-2xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-xl shadow-xl p-6 text-center">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-red-600 via-red-700 to-red-600 hover:from-red-700 hover:via-red-800 hover:to-red-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-red-900/50 transition-all"
            >
