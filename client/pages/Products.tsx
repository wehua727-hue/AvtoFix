                        ...
                        <div className="flex flex-col items-end">
                          <span className="text-sm font-bold text-red-300 leading-none text-red-600">
                            {(() => {
                              ...
                              return convertedPrice.toLocaleString('uz-UZ', {
                              ...
                              if (currency === 'USD') {
                                return (
                                  <>
                                    ...
                                    <span className="text-[9px] opacity-90 text-green-500 font-medium">Dollar</span>
                                  </>
                                );
                              } else if (currency === 'RUB') {
                                return (
                                  <>
                                    <svg className="w-2.5 h-2.5 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-[9px] opacity-90 text-purple-500 font-medium">Rubl</span>
                                  </>
                                );
                                ...
                                return (
                                  <>
                                    ...
                                    <span className="text-[9px] opacity-90 text-red-500 font-medium">Yuan</span>
                                  </>
                                );
                              } else {
                                return (
                                  <>
                                    ...
                                    <span className="text-[9px] opacity-90 text-blue-500 font-medium">So'm</span>
                                  </>
                                );
                              }
                            })()}
...
<hr />
                        {/* Info row */}
                        <div className="grid grid-cols-3 gap-1.5 text-[11px] text-gray-100">
                          ...
                          {p.priceMultiplier != null && (
                            <div className="flex flex-col items-center">
                              <span className="text-[9px] uppercase tracking-[0.18em] text-gray-500 font-semibold">Foiz</span>
                              <span className="font-semibold text-green-500">{p.priceMultiplier}%</span>
                            </div>
                          )}
                          <div className={`flex flex-col ${p.priceMultiplier != null ? 'items-end' : 'items-end col-span-2'}`}>
                        ...
                        <div className="flex gap-1.5 pt-1.5 border-t border-red-900/40 mt-1">
                          ...
                          >
                            ...
                            {productLoadingId === p.id ? 'Yuklanmoqda...' : 'Tahrir'}
                          </button>
                          <button
                            type="button"
                            onClick={(e) => {
