...
export default function Stores() {
  ...
  useEffect(() => {
    ...
    // Load categories from backend (MongoDB)
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className={`pt-16 sm:pt-18 lg:pt-20 transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-20' : 'lg:pl-80'}`}>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-red-950/20 to-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 relative">
            <div className="rounded-3xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-2xl shadow-2xl shadow-red-900/20 px-5 sm:px-8 lg:px-10 py-8 lg:py-10 relative overflow-hidden">
              ...
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-red-600/0 via-red-600/20 to-red-600/0 opacity-0 hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="relative z-10 flex items-center justify-between">
                ...
                <div className="hidden sm:flex items-center justify-center w-20 h-20 bg-gradient-to-br from-red-600 via-red-700 to-red-800 rounded-2xl shadow-2xl shadow-red-900/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {stores.length === 0 ? (
            <div className="text-center py-16 rounded-2xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-xl">
