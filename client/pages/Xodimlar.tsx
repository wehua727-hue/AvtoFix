                  ...
                  >
                    ...
                    >
                      ...
                      <CardContent className="p-3 sm:p-4 relative z-10">
                        ...
                        <div 
                          className="flex items-center justify-between mb-3 pb-3 border-b border-gray-700/50"
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-[10px] sm:text-xs font-medium ${xodim.canEditProducts ? 'text-green-400' : 'text-gray-500'}`}>
                              {xodim.canEditProducts ? "Ko'rsin" : "Ko'rmasin"}
                            </span>
                          </div>
                        ...
                        <div className="flex items-center gap-2.5 sm:gap-3 mb-3">
                          <motion.div 
                            ...
                            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/30 flex items-center justify-center flex-shrink-0"
                          >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <span className="text-[10px] sm:text-xs text-green-400 font-medium">Xodim</span>
                          </div>
                          {loggingInAs === xodim.id ? (
                            <Loader2 className="w-4 h-4 sm:w-5 sm:h-5 animate-spin text-green-500" />
                          ) : (
                            <LogIn className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 group-hover:text-green-400 transition-colors" />
                          )}
                        </div>
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-700/50">
                          <div className="text-[10px] sm:text-xs text-center text-gray-500 group-hover:text-green-400 transition-colors flex items-center justify-center gap-1.5">
