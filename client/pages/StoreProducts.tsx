  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className={`pt-16 sm:pt-18 lg:pt-20 transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-20' : 'lg:pl-80'}`}>
        {/* Header Section */}
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-red-950/20 to-gray-900">
          <div className="pointer-events-none absolute -top-24 -left-16 h-80 w-80 rounded-full bg-red-600/30 blur-3xl animate-pulse" />
          <div className="pointer-events-none absolute bottom-0 right-0 h-96 w-96 translate-x-1/3 translate-y-1/3 rounded-full bg-red-500/20 blur-3xl" />
          
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 relative">
            <div className="rounded-3xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-2xl shadow-2xl shadow-red-900/20 px-5 sm:px-8 lg:px-10 py-8 lg:py-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <div className="relative group">
                      ...
                      <div className="relative bg-gradient-to-br from-red-600 via-red-700 to-red-800 p-3 rounded-2xl shadow-lg">
                  ...
                  <button
                    onClick={() => navigate('/')}
                    className="flex items-center gap-2 px-4 py-2.5 bg-gray-700/50 hover:bg-gray-600/50 border border-gray-600 hover:border-gray-500 text-gray-300 hover:text-white rounded-xl transition-all"
                  >
                ...
                <div className="h-1 w-32 bg-gradient-to-r from-red-500 via-red-600 to-transparent"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-red-600 via-red-700 to-red-600 hover:from-red-700 hover:via-red-800 hover:to-red-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-red-900/50 transition-all flex items-center gap-2"
            >
          ...
          {products.length > 0 && (
            <div className="mb-6">
              <div className="group relative flex items-center rounded-2xl bg-gradient-to-r from-gray-800/50 via-gray-700/50 to-gray-800/50 border border-red-600/20 hover:border-red-500/40 shadow-lg shadow-red-900/10 backdrop-blur transition-all">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-red-600/0 via-red-600/5 to-red-600/0 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          {showEditForm && productToEdit && (
            <div className="mb-6 rounded-2xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-xl shadow-xl p-6">
              ...
              <form onSubmit={handleUpdateProduct} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-red-600 via-red-700 to-red-600 hover:from-red-700 hover:via-red-800 hover:to-red-700 text-white font-semibold py-3 rounded-xl shadow-lg shadow-red-900/50 transition-all disabled:opacity-50"
                  >
          ...
          {filteredProducts.length === 0 && products.length === 0 ? (
            <div className="text-center py-12 rounded-2xl border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-xl">
            ...
            <div className="rounded-2xl overflow-hidden border border-red-600/30 bg-gradient-to-br from-gray-800/80 via-gray-900/80 to-gray-800/80 backdrop-blur-xl shadow-2xl shadow-red-900/20">
