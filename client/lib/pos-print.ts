...
export function printViaBrowser(receipt: ReceiptData): boolean {
  ...
  const html = `
    ...
    <body>
      ...
      <div class="separator"></div>
      ${!isAdminRole ? `
      <div style="text-align: center; margin: 4px 0; padding: 4px 0;">
        <div id="qrcode-main" style="display: inline-block; width: 65px; height: 65px; background: white; border: 1px solid #000;"></div>
      </div>
      <div class="separator"></div>
      ` : ''}
