...
export function printViaBrowser(receipt: ReceiptData): boolean {
  ...
  // Role ga qarab check layout o'zgartiriladi
...
export function printLabelViaBrowser(label: LabelData): boolean {
  ...
  // MUHIM: Barcode ostida ko'rsatish uchun ID (barcode qiymati emas)
  // Agar barcode SKU bo'lsa, uni ko'rsatamiz
  // Agar barcode ID bo'lsa (8 belgili), uni ko'rsatamiz
  const displayText = label.barcode || '';
